package com.zjf.common.redis;

import com.zjf.common.redis.properties.CacheManagerProperties;
import com.zjf.common.redis.properties.LockContextKeyProperties;
import com.zjf.common.redis.templete.RedisRepository;
import com.zjf.common.redis.util.RedisObjectSerializer;
 ...
 * @author Harry
 */
@EnableConfigurationProperties({RedisProperties.class, CacheManagerProperties.class, LockContextKeyProperties.class})
@EnableCaching
public class RedisAutoConfigure {
    ...
    @Autowired
    private LockContextKeyProperties lockContextKeyProperties;
    ...
    public RedisLockRegistry redisLockRegistry(RedisConnectionFactory redisConnectionFactory) {
        return new RedisLockRegistry(redisConnectionFactory, lockContextKeyProperties.getLockContextKey());
    }
